...
To remove data validation from a range, call the  [Range.dataValidation.clear()](/javascript/api/excel/datavalidation#excel-excel-datavalidation-clear-member(1)) method.
