...
> [!NOTE]
> You can conveniently convert a Table object to a Range object by using the [Table.convertToRange()](/javascript/api/excel/table#excel-excel-table-convertToRange-member(1)) method.
