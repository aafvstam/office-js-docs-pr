...
|:-----|:-----|:-----|:-----|
|[bcc](../reference/objectmodel/preview-requirement-set/office.context.mailbox.item.md#properties)|[Recipients](/javascript/api/outlook/office.Recipients)|[Recipients.getAsync](/javascript/api/outlook/Recipients#outlook-office-Recipients-getAsync-member(1))|[Recipients.addAsync](/javascript/api/outlook/Recipients#outlook-office-Recipients-addAsync-member(1)), [Recipients.setAsync](/javascript/api/outlook/Recipients#outlook-office-Recipients-setAsync-member(1))|
|[body](../reference/objectmodel/preview-requirement-set/office.context.mailbox.item.md#properties)|[Body](/javascript/api/outlook/office.Body)|[Body.getAsync](/javascript/api/outlook/Body#outlook-office-Body-getAsync-member(1))|[Body.prependAsync](/javascript/api/outlook/Body#outlook-office-Body-prependAsync-member(1)), [Body.setAsync](/javascript/api/outlook/Body#outlook-office-Body-setAsync-member(1)), [Body.setSelectedDataAsync](/javascript/api/outlook/Body#outlook-office-Body-setSelectedDataAsync-member(1))|
...
|[end](../reference/objectmodel/preview-requirement-set/office.context.mailbox.item.md#properties)|[Time](/javascript/api/outlook/office.Time)|[Time.getAsync](/javascript/api/outlook/Time#outlook-office-Time-getAsync-member(1))|[Time.setAsync](/javascript/api/outlook/Time#outlook-office-Time-setAsync-member(1))|
|[location](../reference/objectmodel/preview-requirement-set/office.context.mailbox.item.md#properties)|[Location](/javascript/api/outlook/office.Location)|[Location.getAsync](/javascript/api/outlook/Location#outlook-office-Location-getAsync-member(1))|[Location.setAsync](/javascript/api/outlook/Location#outlook-office-Location-setAsync-member(1))|
