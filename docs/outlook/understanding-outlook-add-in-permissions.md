...
- Use any of the following APIs.
  ...
  - [item.addFileAttachmentAsync](../reference/objectmodel/preview-requirement-set/office.context.mailbox.item.md#methods)
  - [item.addItemAttachmentAsync](../reference/objectmodel/preview-requirement-set/office.context.mailbox.item.md#methods)
  - [item.bcc.addAsync](/javascript/api/outlook/recipients#outlook-office-recipients-addAsync-member(1))
  - [item.bcc.setAsync](/javascript/api/outlook/recipients#outlook-office-recipients-setAsync-member(1))
  - [item.body.prependAsync](/javascript/api/outlook/body#outlook-office-body-prependAsync-member(1))
  - [item.body.setAsync](/javascript/api/outlook/body#outlook-office-body-setAsync-member(1))
  - [item.body.setSelectedDataAsync](/javascript/api/outlook/body#outlook-office-body-setSelectedDataAsync-member(1))
  - [item.cc.addAsync](/javascript/api/outlook/recipients#outlook-office-recipients-addAsync-member(1))
  - [item.cc.setAsync](/javascript/api/outlook/recipients#outlook-office-recipients-setAsync-member(1))
  - [item.end.setAsync](/javascript/api/outlook/time#outlook-office-time-setAsync-member(1))
  - [item.location.setAsync](/javascript/api/outlook/location#outlook-office-location-setAsync-member(1))
  - [item.optionalAttendees.addAsync](/javascript/api/outlook/recipients#outlook-office-recipients-addAsync-member(1))
  - [item.optionalAttendees.setAsync](/javascript/api/outlook/recipients#outlook-office-recipients-setAsync-member(1))
  - [item.removeAttachmentAsync](../reference/objectmodel/preview-requirement-set/office.context.mailbox.item.md#methods)
  - [item.requiredAttendees.addAsync](/javascript/api/outlook/recipients#outlook-office-recipients-addAsync-member(1))
  - [item.requiredAttendees.setAsync](/javascript/api/outlook/recipients#outlook-office-recipients-setAsync-member(1))
  - [item.start.setAsync](/javascript/api/outlook/time#outlook-office-time-setAsync-member(1))
  - [item.subject.setAsync](/javascript/api/outlook/subject#outlook-office-subject-setAsync-member(1))
  - [item.to.addAsync](/javascript/api/outlook/recipients#outlook-office-recipients-addAsync-member(1))
  - [item.to.setAsync](/javascript/api/outlook/recipients#outlook-office-recipients-setAsync-member(1))
