...
The following example shows how to add a category named "Urgent!" to the master list by calling [addAsync](/javascript/api/outlook/mastercategories#outlook-office-mastercategories-addAsync-member(1)) on [mailbox.masterCategories](/javascript/api/outlook/mailbox#outlook-office-mailbox-masterCategories-member).
...
The following example shows how to get the list of categories by calling [getAsync](/javascript/api/outlook/mastercategories#outlook-office-mastercategories-getAsync-member(1)) on [mailbox.masterCategories](/javascript/api/outlook/mailbox#outlook-office-mailbox-masterCategories-member).
...
The following example shows how to remove the category named "Urgent!" from the master list by calling [removeAsync](/javascript/api/outlook/mastercategories#outlook-office-mastercategories-removeAsync-member(1)) on [mailbox.masterCategories](/javascript/api/outlook/mailbox#outlook-office-mailbox-masterCategories-member).
...
The following example shows how to apply the category named "Urgent!" to the current item by calling [addAsync](/javascript/api/outlook/categories#outlook-office-categories-addAsync-member(1)) on `item.categories`.
...
The following example shows how to get the categories applied to the current item by calling [getAsync](/javascript/api/outlook/categories#outlook-office-categories-getAsync-member(1)) on `item.categories`.
...
The following example shows how to remove the category named "Urgent!" from the current item by calling [removeAsync](/javascript/api/outlook/categories#outlook-office-categories-removeAsync-member(1)) on `item.categories`.
