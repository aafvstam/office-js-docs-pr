...
|---|---|
| [item.location](/javascript/api/outlook/appointmentread#outlook-office-appointmentread-location-member) | Attendee/Read |
| [item.location.getAsync](/javascript/api/outlook/location#outlook-office-location-getAsync-member(1)) | Organizer/Compose |
| [item.location.setAsync](/javascript/api/outlook/location#outlook-office-location-setAsync-member(1)) | Organizer/Compose |
| [item.enhancedLocation.getAsync](/javascript/api/outlook/enhancedlocation#outlook-office-enhancedlocation-getAsync-member(1)) | Organizer/Compose,<br>Attendee/Read |
| [item.enhancedLocation.addAsync](/javascript/api/outlook/enhancedlocation#outlook-office-enhancedlocation-addAsync-member(1)) | Organizer/Compose |
| [item.enhancedLocation.removeAsync](/javascript/api/outlook/enhancedlocation#outlook-office-enhancedlocation-removeAsync-member(1)) | Organizer/Compose |
...
The following example shows how to add a location by calling [addAsync](/javascript/api/outlook/enhancedlocation#outlook-office-enhancedlocation-addAsync-member(1)) on [mailbox.item.enhancedLocation](/javascript/api/outlook/appointmentcompose#outlook-office-appointmentcompose-enhancedLocation-member).
...
The following example shows how to get the location by calling [getAsync](/javascript/api/outlook/enhancedlocation#outlook-office-enhancedlocation-getAsync-member(1)) on [mailbox.item.enhancedLocation](/javascript/api/outlook/appointmentread#outlook-office-appointmentread-enhancedLocation-member).
...
The following example shows how to remove the location by calling [removeAsync](/javascript/api/outlook/enhancedlocation#outlook-office-enhancedlocation-removeAsync-member(1)) on [mailbox.item.enhancedLocation](/javascript/api/outlook/appointmentcompose#outlook-office-appointmentcompose-enhancedLocation-member).
