...
- [Section.addPage](/javascript/api/onenote/section#onenote-onenote-section-addPage-member(1))
- [Page.insertPageAsSibling](/javascript/api/onenote/section#onenote-onenote-section-insertSectionAsSibling-member(1))
