...
||[onVisibilityChanged](/javascript/api/excel/worksheetcollection#excel-excel-worksheetcollection-onVisibilityChanged-member)|Occurs when the worksheet visibility is changed in the worksheet collection.|
