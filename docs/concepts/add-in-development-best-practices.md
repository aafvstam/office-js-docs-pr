...
- Use the [Context.touchEnabled](/javascript/api/office/context#office-office-context-touchEnabled-member) property to detect whether the Office application that your add-in runs on is touch enabled.
